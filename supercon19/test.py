...
from greatfet.gnuradio import i2c
from gnuradio import qtgui
...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.i2c_register_source_0 = i2c.I2CSourceBlock(samp_rate, 8, "[1]", 1, 100, '')
        ...
        # Connections
        ##################################################
        self.connect((self.analog_frequency_modulator_fc_0, 0), (self.qtgui_sink_x_0, 0))
        self.connect((self.i2c_register_source_0, 0), (self.rational_resampler_xxx_0, 0))
